...
public class HttpContentReader implements ContentReader {
    ...
    private static final Logger logger = LoggerFactory.getLogger(HttpContentReader.class);
    private final HttpClient client;

    public HttpContentReader() throws KeyManagementException, NoSuchAlgorithmException {
